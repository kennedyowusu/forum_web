      ...
      <div className='mt-3'>
        <div className='flex items-center'>
          <div className='flex items-center'>
            <Icon
              icon='wpf:like'
              className='text-gray-500 text-md cursor-pointer hover:text-blue-500 mr-1'
            />
          ...
          <div className='flex items-center ml-3'>
            <Icon
              ...
              className='text-gray-500 text-sm cursor-pointer hover:text-blue-500 mr-1'
            />
            <p className='text-gray-500 text-sm ml-1 hover:text-gray-500'>
          ...
          <div className='flex items-center ml-3'>
            <Icon
              ...
              className='text-gray-500 text-sm cursor-pointer hover:text-gray-500 mr-1'
            />
          </div>
        </div>
      </div>
