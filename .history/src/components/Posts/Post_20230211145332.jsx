      ...
      <div className='mt-3'>
        <div className='flex items-center'>
          ...
          <div className='ml-3'>
            ...
            <p className='text-gray-500 text-sm '>2 hours ago</p> */}
       <input type="text" 
       className="w-full border border-gray-300 rounded-md py-2 px-4 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent outline-0 bg-[#f2f3f7] pl-3 h-12 "
       />
