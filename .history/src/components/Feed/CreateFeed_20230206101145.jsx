  ...
  return (
    <div>
      <div className='my-8 bg-white flex flex-col w-full'>
        ...
        <div className='bg-[#ffffff] flex items-center mx-5 w-full h-16 border-b'>
          <input
            type='text'
     ...
     <div
      className='bg-[#ffffff] flex items-center mx-5 w-full h-24 border-b'
     >
      <textarea
       className='outline-0 bg-[#f2f3f7] w-[40rem] pl-3 p-1'
       placeholder='Enter Title...'
       rows='4'
       cols='50'
      />
