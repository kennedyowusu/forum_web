...
const CreateFeed = () => {
  return (
    ...
    >
      <div
        className='my-8 bg-white flex flex-col w-full p-3 rounded-md
    shadow-md sm:mx-auto sm:w-[40rem] md:mx-auto md:w-[40rem] lg:mx-auto lg:w-[40rem] xl:mx-auto xl:w-[40rem]
      '
      >
        ...
        <div className='flex items-center mx-5 h-24 rounded-md bg-red-600'>
          <textarea
