...
const CreateFeed = () => {
  return (
    <div>
      <div className='my-8 bg-white flex flex-col w-full h-44'>
        ...
        <div className='bg-[#ffffff] flex items-center mx-5 w-full h-16'>
          <input
            ...
            className='outline-0 zw-[40rem] pl-3 h-12  rounded-md p-1'
          />
        </div>
        ...
        <div className='bg-[#ffffff] flex items-center mx-5 w-full h-24 rounded-md'>
          <textarea
            ...
            rows='4'
            cols='50'
            className='outline-0 bg-[#f2f3f7] w-[40rem] pl-3 h-16  rounded-md p-1'
          />
        </div>
