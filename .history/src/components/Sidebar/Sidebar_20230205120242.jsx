            ...
            <ul class='space-y-4 mb-12 px-4 mt-8'>
              <li>
                <NavLink
                  ...
                  // class='flex gap-4 text-gray-600 hover:text-gray-800 transition'
                >
                  {/* <img
                    src='https://raw.githubusercontent.com/Meschacirung/Tailus-website/f59a4b3ecc1ad9f6a2b0ad9e3fca6f957140cc4d/public/images/icons/home.svg'
                    className='w-6'
                    alt=''
                  /> */}
                  <Icon icon='material-symbols:home-outline-rounded'
                    className="
                    w-6 h-6 text-gray-600 hover:text-gray-800 transition color
                    "/>
                  Home
                </NavLink>
              </li>
