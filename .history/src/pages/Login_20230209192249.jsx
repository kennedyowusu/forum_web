    ...
    <div className='grid grid-cols-1 sm:grid-cols-2 h-screen w-full'>
      ...
      <div className='bg-gray-800 flex flex-col justify-center'>
        ...
        >
          ...
          <button
            className={`$(
                checkEmptyFields() ? 'bg-gray-700' : 'bg-teal-500' : 'w-full my-5 py-2 bg-teal-500 shadow-lg shadow-teal-500/50 hover:shadow-teal-500/40 text-white font-semibold rounded-lg' 
              )`}
            type='submit'
            disabled={loading}
          >
