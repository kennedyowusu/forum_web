...
const Home = () => {
  ...
  return (
    <>
      <section className='flex flex-col h-[100vh] items-center'>
      ...
      {/* Put two cards side-by-side to display the input from the input fields */}
      <section className='flex flex-col h-[100vh] items-center justify-center space-y-5'>
        <div className='flex flex-col space-y-5 items-center'>
          <div className='flex flex-col space-y-2 w-[50%] top-6 top-64 absolute md:right-52'>
