...
const Login = () => {
  ...
  const stateness = useSelector(SelectLoginState)
  const loading = stateness.loading
  const success = stateness.success
  const user = stateness.user
  const errorMessage = stateness.errorMessage
  const errorStrings = stateness.errorStrings
  ...
  }, [errorMessage, navigate, success, token, user, user.username])
