...
const Login = () => {
  ...
  const { loading, success, user, errorMessage } = useSelector(SelectLoginState)
    ...
    <div className='grid grid-cols-1 sm:grid-cols-2 h-screen w-full'>
      ...
      <div className='bg-gray-800 flex flex-col justify-center'>
        ...
        >
          ...
          <button
            className={`${
                checkEmptyFields() ? "bg-gray-500 cursor-not-allowed text-gray-400" : "bg-teal-500 shadow-teal-500/50 hover:shadow-teal-500/40"
